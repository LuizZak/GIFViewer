...
namespace GifComponents.Components
{
	...
	public abstract class GifComponent : IDisposable
	{
		...
		#endregion
		// TODO: consider moving methods which interact with XmlWriters etc into their own class.
		...
		/// <summary>
		/// Writes the debug XML of a child component to the current component's 
		/// debug XML stream.
		/// If the XmlDebugging property is set to false, does nothing.
		/// </summary>
		/// <param name="reader">
		/// The DebugXmlReader property of the child component.
		/// </param>
		protected void WriteDebugXmlNode( XmlReader reader )
		{
			// TESTME: WriteDebugXmlNode
			if( _xmlDebugging )
			{
		...
		/// If the XmlDebugging property is set to false, does nothing.
		/// </summary>
		/// <param name="text">The markup to write</param>
		protected void WriteDebugXmlRaw( string text )
		{
			// TODO: Is WriteDebugXmlRaw needed? Only called from unit tests
			if( _xmlDebugging )
			{
		...
		/// If the XmlDebugging property is set to false, does nothing.
		/// </summary>
		/// <param name="name">The name of the element to start writing.</param>
